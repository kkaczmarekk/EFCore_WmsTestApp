...
{
    public class ItemReviewRemoveHandler : IEntityEventHandler<ItemReviewRemoveEvent>
    {
        public IStatusValidator Handle(object callingEntity, ItemReviewRemoveEvent entityEvent)
        {
            ...
            status.CombineStatues(callingItem.Cashed.CashedReviewsDataRecalculate_Remove(entityEvent.VotedStars));
